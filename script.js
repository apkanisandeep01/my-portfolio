document.addEventListener('DOMContentLoaded', function() {
    ...
    const portfolioData = {
        ...
        apps: [
            ...
            { icon: 'fab fa-light fa-wheat', color: 'icon-tertiary', title: '', text: 'A tool for efficient merging and generating insights, (Departmnet Use only).', appUrl: 'https://cropverificationdata.streamlit.app/', codeUrl: 'https://github.com/apkanisandeep01/Crop-Verification-Merger.git' },
            ...
            { icon: 'fas fa-file-chart-column', color: 'icon-primary', title: 'Crop Damage Proforma Generator', text: 'A tool for efficient merging and generating Crop damage report proforma, (Departmnet Use only).', appUrl: 'https://agricropdamage.streamlit.app', codeUrl: 'https://github.com/apkanisandeep01/Crop-Damage-Report.git' }
        ],
        projects: [
