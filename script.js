document.addEventListener('DOMContentLoaded', function() {
    ...
    const portfolioData = {
        ...
        apps: [
            ...
            { icon: 'fas fa-file-chart-line', color: 'icon-danger', title: 'Crop Damage Proforma Generator', text: 'A tool for efficient merging and generating Crop damage report proforma, (Departmnet Use only).', appUrl: 'https://agricropdamage.streamlit.app', codeUrl: 'https://github.com/apkanisandeep01/Crop-Damage-Report.git' }
        ],
        projects: [
