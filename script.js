document.addEventListener('DOMContentLoaded', function() {
    ...
    const portfolioData = {
        ...
        apps: [
            ...
            { icon: '🌾', color: 'icon-tertiary', title: '', text: 'A tool for efficient merging and generating insights, (Departmnet Use only).', appUrl: 'https://cropverificationdata.streamlit.app/', codeUrl: 'https://github.com/apkanisandeep01/Crop-Verification-Merger.git' },
